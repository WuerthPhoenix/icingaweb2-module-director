...
CREATE TABLE director_activity_log (
  ...
  live_modification ENUM('scheduled', 'succeeded', 'failed', 'impossible', 'disabled') NOT NULL, -- partial ???
  PRIMARY KEY (id),
...
CREATE TABLE icinga_modified_attribute (
    ...
    -- icinga_object_checksum VARBINARY(32) NOT NULL, -- SHA1(icinga_object_type!icinga_object_name)
    PRIMARY KEY (id),
